...
file_path = "/Users/karthikeyan/Documents/driver-admin/vDrive-admin/src/pages/Promotions.tsx"
...
content = re.sub(r'\btext-gray-700\b(?! dark:text-)', 'text-gray-700 dark:text-slate-300', content)
...
# Replace any Drawers to have rootClassName="dark-drawer"
