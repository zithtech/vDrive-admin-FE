    ...
    <div className="relative bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-3 flex flex-col justify-between hover:shadow-sm transition-all duration-300 h-[80px] overflow-hidden group">
      ...
      <div className="flex items-baseline justify-between mt-auto">
        <div className="flex items-baseline gap-1">
          ...
          {subtitle && <span className="text-[9px] text-gray-400 dark:text-gray-500 font-medium lowercase italic">{subtitle}</span>}
        </div>
    ...
    <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl shadow-sm flex flex-col h-105 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-100 dark:border-slate-700">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900 dark:text-white text-[14px] tracking-tight">Live Driver Status</span>
        </div>
      ...
      <div className="flex-1 p-3.5 bg-gray-50/20 dark:bg-slate-900/50 overflow-y-auto custom-scrollbar">
        ...
        <div className="flex items-center gap-3 my-4">
          ...
          <span className="text-[10px] font-bold text-gray-300 dark:text-gray-500 uppercase tracking-widest">Fleet Health</span>
          <div className="h-px bg-gray-100 dark:bg-slate-700 flex-1"></div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center">
              <Progress 
                ...
                strokeWidth={10}
                format={(percent) => (
                  <span className="text-[13px] font-bold text-gray-900 dark:text-white">{percent}%</span>
                )}
              />
              <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 mt-3 uppercase tracking-wider">Availability</span>
            </div>
            <div className="flex flex-col items-center">
              <Progress 
                type="circle" 
              ...
              />
              <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 mt-3 uppercase tracking-wider">Active Fleet</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-5 p-3 bg-blue-50/50 dark:bg-blue-900/20 rounded-xl border border-blue-100/50 dark:border-blue-800/50 flex items-center justify-between">
            <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-bold text-blue-900 dark:text-blue-200">Total Drivers</span>
            </div>
            <span className="text-[13px] font-black text-blue-600 dark:text-blue-400">{stats.totalDrivers}</span>
        </div>
      </div>
