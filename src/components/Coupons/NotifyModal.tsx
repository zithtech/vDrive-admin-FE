  ...
  return (
    <Modal
      ...
      footer={[
        <Button
          key="cancel"
          onClick={onCancel}
          className="rounded-xl border-none text-slate-400 font-bold hover:text-slate-600 h-12 px-6"
        >
    ...
    >
      <div className="py-4">
        {!isAllowed && (
          <div className="mb-4 bg-amber-50 border border-amber-200 text-amber-800 p-4 rounded-[1.5rem] text-xs flex items-start gap-2 shadow-sm">
            ...
            <div>
              ...
              <span>
                You do not have permission to trigger notification campaigns for this asset.
                Selection options have been locked.
              </span>
            </div>
          </div>
        )}
        <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-6 rounded-[2rem] border border-blue-100 mb-8 relative overflow-hidden shadow-sm">
          ...
          <div className="flex justify-between items-end relative z-10">
            <div>
              <Title
                level={2}
                className="!m-0 !text-indigo-900 font-mono tracking-wider !leading-none"
              >
                {coupon?.code}
              </Title>
            ...
            <div
              className={`px-4 py-2 rounded-2xl font-black text-xs shadow-lg shadow-indigo-100 ${
        ...
        <div className="mb-8">
          <Text className="text-slate-400 font-black text-[10px] uppercase tracking-widest mb-3 block px-1">
            Select Audience
          </Text>
          <Select
              ...
              <div className="flex items-center gap-2 py-1">
                ...
                <div>
                  ...
                  <div className="text-[9px] text-slate-400 uppercase font-bold tracking-tight">
                    All Active Platform {isDriverPromotion ? "Drivers" : "Users"}
                  </div>
                </div>
              </div>
            </Option>
          ...
          <div className="mb-8 animate-in fade-in slide-in-from-top-2 duration-500">
            ...
            <Select
              ...
              filterOption={(input, option) => {
                const user = (currentAudience as any[]).find(
                  (u) => (u.id || u.driver_id) === option?.key,
                );
        ...
        <div className="text-xs text-gray-500 italic bg-gray-50 p-3 rounded-lg border border-gray-100">
          <p className="m-0">
            Note: Emails will be processed in batches by the background cron job every 5 minutes to
