    ...
    <div className="flex flex-col h-full overflow-hidden p-3 gap-3 bg-gray-50 dark:bg-slate-700/30 min-h-screen font-sans">
      ...
      <div className="flex flex-wrap md:flex-nowrap items-center justify-between gap-4 shrink-0 bg-white dark:bg-slate-800 p-3 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="!m-0 text-sm font-black text-gray-900 dark:text-slate-100 tracking-tight uppercase">
              Campaigns
            </h1>
            <p className="text-[9px] text-gray-400 dark:text-slate-500 font-bold uppercase tracking-widest mt-0.5">
              Offers & Promos
            </p>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-4 px-4 border-l border-r border-gray-100 dark:border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-widest leading-none">
                Active
              </span>
              <span className="text-xs font-black text-gray-900 dark:text-slate-100 leading-none mt-1">
                {stats.active}
              </span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 flex-1 md:flex-none justify-end">
          <div className="relative w-48 group/search">
            <Search
              className="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-300 dark:text-slate-500 group-focus-within/search:text-indigo-500 transition-colors"
              size={12}
            />
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 pb-4">
          {loading ? (
            [1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className="bg-white dark:bg-slate-800 h-28 rounded-xl animate-pulse border border-gray-100 dark:border-slate-700"
              />
            ))
              ...
              return (
                ...
                >
                  <div className="p-3 flex items-start gap-3 border-b border-gray-50 dark:border-slate-700/50">
                    <div
                      className={`w-8 h-8 rounded-lg ${themeBg} flex items-center justify-center text-white shrink-0`}
                    >
                      {isPercentage ? (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <h3 className="text-xs font-black text-gray-900 dark:text-slate-100 font-mono tracking-tight truncate">
                          {promo.code}
                        </h3>
                      ...
                      <p
                        className="text-[10px] font-medium text-gray-500 dark:text-slate-400 truncate mt-0.5"
                  ...
                  <div className="p-3 flex items-center justify-between gap-2 bg-gray-50/50 dark:bg-slate-800/30">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] font-extrabold text-gray-700 dark:text-slate-300 capitalize truncate max-w-[80px]">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className={`text-[10px] font-extrabold ${textTheme}`}>
                        {promo.usage_count}{" "}
                        <span className="text-gray-400 font-medium">/ {promo.max_uses || "∞"}</span>
                      </span>
                    </div>
                    <div className="w-px h-6 bg-gray-200 dark:bg-slate-700"></div>
                    <div className="flex flex-col items-end">
                      ...
                      <span className="text-[10px] font-extrabold text-gray-700 dark:text-slate-300">
            ...
            <div className="col-span-full py-12 bg-white dark:bg-slate-800 rounded-xl text-center border border-dashed border-gray-200 dark:border-slate-600 flex flex-col items-center justify-center gap-3">
              ...
              <div>
                <p className="text-gray-500 dark:text-slate-400 font-bold text-xs">
                  No campaigns found
                </p>
              </div>
              <Button
                ...
                size="small"
                onClick={() => handleOpenDrawer()}
                className="bg-indigo-600 text-[10px] font-bold mt-1"
              >
                Create Offer
              </Button>
            </div>
